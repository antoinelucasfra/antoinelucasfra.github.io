...
<div class="cv-page">
  ...
  <p class="cv-summary">
    ...
    modelling, Design of Experiments (DoE), applied ML (computer vision, natural language processing (NLP)), and multi-omics
...
- Fine-tuned a Phi-3 large language model (LLM, Microsoft) on open Hugging Face datasets for fake news detection and climate claim proof retrieval — full pipeline from data preparation to evaluation
:::
...
```{=html}
  ...
  <div class="cv-skills-grid">
    ...
    <div class="cv-skill-row">
      ...
      <span class="cv-skill-value">Docker · GitHub Actions · Posit Connect · Azure ML · Databricks · renv · uv</span>
    </div>
    <div class="cv-skill-row">
