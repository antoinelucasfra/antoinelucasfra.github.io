...
::: {.hero-tagline}
R / Shiny Developer · Scientific Software & Applied Statistics
:::
...
- [Voice to Data: LLM Pipeline for Lab Notebooks](/projects/voice-to-data.qmd) — local-first extraction pipeline built for regulated R&D constraints.
