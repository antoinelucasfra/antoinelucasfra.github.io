...
Design of Experiments (DoE), applied ML (computer vision, natural language processing (NLP)), and multi-omics analysis. Proven
...
| **MLOps** | Docker · GitHub Actions · Posit Connect · Azure ML · Databricks · renv · uv |
