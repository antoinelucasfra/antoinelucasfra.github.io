...
# ── Load data ─────────────────────────────────────────────────────────────────
resources_raw <- readr::read_delim(
...
::: {.callout-note}
## Contributing
Want to add a resource? Edit `data/resources.csv` and open a PR on [GitHub](https://github.com/antoinelucasfra/antoinelucasfra.github.io).
:::
