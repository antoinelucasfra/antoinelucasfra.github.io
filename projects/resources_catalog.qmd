  ...
  function applyAll(resetPage) {
    ...
    gridWrappers.forEach(function (wrapper, idx) {
      ...
      if (show && query) {
        ...
        const linkVal  = (wrapper.dataset.link || '').toLowerCase();
        show = title.includes(query) || cats.includes(query) || descText.includes(query) || linkVal.includes(query);
      }
