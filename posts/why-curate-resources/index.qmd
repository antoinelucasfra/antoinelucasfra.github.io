...
image: ../../assets/images/covers/why-curate-resources.svg
---
...
That's why I created the [Resources Catalog](/projects/resources_catalog.html) — a curated collection of data science resources organized by type, language, and category.
...
Browse my [Resources Catalog](/projects/resources_catalog.html). Fork it, adapt it, build your own. The goal isn't to have *my* collection — it's to have *a* collection that serves your learning journey.

That is the real payoff of curation: not a prettier bookmark list, but a working system for staying oriented in a field that changes faster than memory alone can handle.

---

## Further Resources for Resource Curation
...
*The [Resources Catalog](/projects/resources_catalog.html) is updated in public. Contributions are welcome via [GitHub](https://github.com/antoinelucasfra/antoinelucasfra.github.io).*
