...
image: ../../assets/images/covers/quarto-getting-started.svg
---
...
One syntax detail worth memorizing: when callouts (or any panels) nest, the outer fence needs **more colons** than the inner one — otherwise the first inner `:::` closes the outer block:
...
Rule of thumb: count your nesting depth, add that many colons to the outermost fence.
